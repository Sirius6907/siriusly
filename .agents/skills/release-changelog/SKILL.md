...
description: >
  Generate the stable SiriusEcoSystem release changelog at releases/vYYYY.MDD.P.md by
  reading commits, changesets, and merged PR context since the last stable tag.
---

# Release Changelog Skill

Generate the user-facing changelog for the **stable** SiriusEcoSystem release.

## Versioning Model

SiriusEcoSystem uses **calendar versioning (calver)**:
...
```
- **Feature name** — Description. ([#123](https://github.com/sirius-eco-system/sirius-eco-system/pull/123), @contributor1, @contributor2)
```
