...
name: release
description: >
  Coordinate a full SiriusEcoSystem release across engineering verification, npm,
...
Run the full SiriusEcoSystem maintainer release workflow, not just an npm publish.
...
7. If running through SiriusEcoSystem, you have issue context for status updates and follow-up task creation.
...
SiriusEcoSystem now uses a commit-driven release model:
...
npm view sirius-eco-system@canary version
```
...
- release summary in SiriusEcoSystem issue context
