...
import { resolveDefaultLogsDir, resolveSiriusEcoSystemInstanceId } from "../config/home.js";

export async function promptLogging(): Promise<LoggingConfig> {
  const defaultLogDir = resolveDefaultLogsDir(resolveSiriusEcoSystemInstanceId());
