...
Low-level reference for how SiriusEcoSystem packages are prepared and published to npm.
...
SiriusEcoSystem no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `sirius-eco-system`, imports code from workspace packages such as:

- `@sirius-eco-system/server`
- `@sirius-eco-system/db`
...
## `@sirius-eco-system/ui` packaging
...
SiriusEcoSystem uses calendar versions:
...
- `sirius-eco-system@2026.318.1-canary.2`
