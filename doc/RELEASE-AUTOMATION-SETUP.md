...
This document covers the GitHub and npm setup required for the current SiriusEcoSystem release model:
...
Do this for every public package that SiriusEcoSystem publishes.

At minimum that includes:

- `sirius-eco-system`
- `@sirius-eco-system/server`
- `@sirius-eco-system/ui`
...
3. add a trusted publisher for the GitHub repository `sirius-eco-system/sirius-eco-system`
...
- `sirius-eco-system/sirius-eco-system`
...
2. revoke any personal automation token that used to publish SiriusEcoSystem
