...
This is intentionally separate from the normal SiriusEcoSystem dev image.
...
```sh
review-checkout-pr sirius-eco-system/sirius-eco-system 432
cd /work/checkouts/sirius-eco-system-sirius-eco-system/pr-432
```
...
## Preview the SiriusEcoSystem app from the PR
...
- SiriusEcoSystem's embedded PostgreSQL and local storage stay inside the container home volume via `SIRIUSLY_HOME=/home/reviewer/.sirius-eco-system-review`.
