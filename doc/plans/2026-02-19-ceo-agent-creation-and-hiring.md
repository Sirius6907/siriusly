...
- installed adapter list for this SiriusEcoSystem instance
...
## 8. New Skill: `sirius-eco-system-create-agent`

Create new skill directory:

- `skills/sirius-eco-system-create-agent/SKILL.md`
...
Also update `skills/sirius-eco-system/SKILL.md` to reference this skill for hiring workflows.
...
- `sirius-eco-system-create-agent` skill + docs updates
