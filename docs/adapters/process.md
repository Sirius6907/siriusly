...
- Running a Python script that calls the SiriusEcoSystem API
...
1. SiriusEcoSystem spawns the configured command as a child process
2. Standard SiriusEcoSystem environment variables are injected (`SIRIUSLY_AGENT_ID`, `SIRIUSLY_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the SiriusEcoSystem API and perform work.
