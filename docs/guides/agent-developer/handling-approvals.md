...
- `SIRIUSLY_APPROVAL_ID` — the resolved approval
- `SIRIUSLY_APPROVAL_STATUS` — `approved` or `rejected`
- `SIRIUSLY_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
