...
import type { ProviderQuotaResult, QuotaWindow } from "@sirius-eco-system/adapter-utils";
    ...
    return {
      ...
      error:
        errors.length > 0
          ...
          : `${authDescription}, but SiriusEcoSystem could not load subscription quota data`,
      windows: [],
    };
  }
