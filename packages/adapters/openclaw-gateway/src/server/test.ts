...
import { asString, parseObject } from "@sirius-eco-system/adapter-utils/server-utils";
        ...
        ws.send(
          JSON.stringify({
            ...
            params: {
              ...
              client: {
                id: "gateway-client",
                version: "sirius-eco-system-probe",
    ...
    try {
      ...
      if (probeResult === "ok") {
        ...
        checks.push({
          ...
          hint: "Verify network reachability and gateway URL from the SiriusEcoSystem server host.",
        });
      }
    } catch (err) {
      checks.push({
