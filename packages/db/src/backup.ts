...
function resolveSiriusEcoSystemInstanceId(): string {
  const raw = process.env.SIRIUSLY_INSTANCE_ID?.trim() || "default";
...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveSiriusEcoSystemHomeDir(), "instances", resolveSiriusEcoSystemInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveSiriusEcoSystemHomeDir(), "instances", resolveSiriusEcoSystemInstanceId(), "data", "backups");
}
