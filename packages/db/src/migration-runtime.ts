...
async function ensureEmbeddedPostgresConnection(
  ...
  const preferredAdminConnectionString = `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${preferredPort}/postgres`;
  ...
  if (!runningPid && existsSync(pgVersionFile)) {
    try {
      ...
      await ensurePostgresDatabase(preferredAdminConnectionString, "siriusEcoSystem");
      process.emitWarning(
      ...
      return {
        connectionString: `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${preferredPort}/siriusEcoSystem`,
  ...
  if (runningPid) {
    ...
    const adminConnectionString = `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${port}/postgres`;
    await ensurePostgresDatabase(adminConnectionString, "siriusEcoSystem");
    return {
      connectionString: `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${port}/siriusEcoSystem`,
  ...
  const adminConnectionString = `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${selectedPort}/postgres`;
  await ensurePostgresDatabase(adminConnectionString, "siriusEcoSystem");

  return {
    connectionString: `postgres://siriusEcoSystem:siriusEcoSystem@127.0.0.1:${selectedPort}/siriusEcoSystem`,
