...
import type { PluginCategory, PluginStatus, SiriusEcoSystemPluginManifestV1 } from "@sirius-eco-system/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<SiriusEcoSystemPluginManifestV1>().notNull(),
