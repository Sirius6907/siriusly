import type { PluginLauncherRegistration } from "@sirius-eco-system/plugin-sdk";

export const PLUGIN_ID = "sirius-eco-system-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".sirius-eco-system-kitchen-sink-demo.txt",
} as const;
