/**
 * Bundling presets for SiriusEcoSystem plugins.
 *
 ...
 * to match the SiriusEcoSystem plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@sirius-eco-system/plugin-sdk/ui",
    "@sirius-eco-system/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
  ...
  const rollupManifest: RollupLikeConfig = {
    ...
    external: ["@sirius-eco-system/plugin-sdk"],
  };
