/**
 * `definePlugin` — the top-level helper for authoring a SiriusEcoSystem plugin.
 *
...
// ---------------------------------------------------------------------------
// SiriusEcoSystemPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface SiriusEcoSystemPlugin {
...
/**
 * Define a SiriusEcoSystem plugin.
 *
 ...
 * @returns A sealed `SiriusEcoSystemPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@sirius-eco-system/plugin-sdk";
