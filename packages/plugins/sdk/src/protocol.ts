 ...
 * channel.
 *
 * The SiriusEcoSystem plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@sirius-eco-system/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all SiriusEcoSystem messages.
 */
...
/**
 * SiriusEcoSystem plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this SiriusEcoSystem instance. */
    instanceId: string;
    /** Semver version of the running SiriusEcoSystem host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
