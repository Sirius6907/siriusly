...
function requireCapability(manifest: SiriusEcoSystemPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the SiriusEcoSystem server runtime.
 */
