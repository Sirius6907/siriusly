/**
 * Core types for the SiriusEcoSystem plugin worker-side SDK.
 *
 * These types define the stable public API surface that plugin workers import
 * from `@sirius-eco-system/plugin-sdk`.  The host provides a concrete implementation
...
// ---------------------------------------------------------------------------
// Re-exports from @sirius-eco-system/shared (plugin authors import from one place)
// ---------------------------------------------------------------------------
...
export interface ScopeKey {
  /** What kind of SiriusEcoSystem object this state is scoped to. */
...
export interface PluginEntityUpsert {
  ...
  externalId?: string;
  /** Human-readable title for display in the SiriusEcoSystem UI. */
  title?: string;
...
/**
 * `ctx.events` — subscribe to and emit SiriusEcoSystem domain events.
 *
...
export interface PluginEventsClient {
  /**
   * Subscribe to a core SiriusEcoSystem domain event or a plugin-namespaced event.
   *
 ...
 * This client resolves the reference through the SiriusEcoSystem secret provider
...
export interface PluginSecretsClient {
   ...
   * in the SiriusEcoSystem secret provider (e.g. `"MY_API_KEY"`).
   *
 ...
 * ```
 *
 * @see usePluginStream in `@sirius-eco-system/plugin-sdk/ui`
 */
 ...
 * @example
 * ```ts
 * import { definePlugin } from "@sirius-eco-system/plugin-sdk";
 *
