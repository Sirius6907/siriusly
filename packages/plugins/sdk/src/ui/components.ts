 ...
 *
 * These components are exported from `@sirius-eco-system/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@sirius-eco-system/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function SiriusEcoSystemSdkUiComponent(props: TProps) {
