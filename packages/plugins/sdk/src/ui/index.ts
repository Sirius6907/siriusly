/**
 * `@sirius-eco-system/plugin-sdk/ui` — SiriusEcoSystem plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@sirius-eco-system/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@sirius-eco-system/plugin-sdk/ui";
 *
