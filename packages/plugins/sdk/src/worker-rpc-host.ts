...
import type { SiriusEcoSystemPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@sirius-eco-system/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: SiriusEcoSystemPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@sirius-eco-system/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
