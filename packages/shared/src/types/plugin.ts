...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within SiriusEcoSystemPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the SiriusEcoSystem host.
 *
...
export interface SiriusEcoSystemPluginManifestV1 {
   ...
   */
  minimumSiriusEcoSystemVersion?: PluginMinimumHostVersion;
