...
import { models as codexFallbackModels } from "@sirius-eco-system/adapter-codex-local";
import { models as cursorFallbackModels } from "@sirius-eco-system/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@sirius-eco-system/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.SIRIUSLY_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.SIRIUSLY_OPENCODE_COMMAND = "__siriusEcoSystem_missing_opencode_command__";
