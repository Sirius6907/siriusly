...
describe("shouldTrackDevServerPath", () => {
  it("ignores repo-local SiriusEcoSystem state and common test file paths", () => {
    expect(
      shouldTrackDevServerPath(
        ".siriusEcoSystem/worktrees/PAP-712-for-project-configuration-get-rid-of-the-overview-tab-for-now/.agents/skills/siriusEcoSystem",
      ),
    ).toBe(false);
