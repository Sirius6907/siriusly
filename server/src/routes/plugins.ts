...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@sirius-eco-system/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@sirius-eco-system/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@sirius-eco-system/plugin-sdk";
import { assertBoard, assertCompanyAccess, getActorInfo } from "./authz.js";
import { validateInstanceConfig } from "../services/plugin-config-validator.js";

/** UI slot declaration extracted from plugin manifest */
type PluginUiSlotDeclaration = NonNullable<NonNullable<SiriusEcoSystemPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<SiriusEcoSystemPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @siriusEcoSystem/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@sirius-eco-system/plugin-hello-world-example",
    pluginKey: "siriusEcoSystem.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the SiriusEcoSystem dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@sirius-eco-system/plugin-file-browser-example",
    pluginKey: "sirius-eco-system-file-browser-example",
  ...
  {
    packageName: "@sirius-eco-system/plugin-kitchen-sink-example",
    pluginKey: "sirius-eco-system-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current SiriusEcoSystem plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "siriusEcoSystem.claude-usage",
