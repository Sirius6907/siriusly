 ...
 */
import type { CompanyPortabilityManifest } from "@sirius-eco-system/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [SiriusEcoSystem](https://siriusEcoSystem.ing)");
  lines.push("");
