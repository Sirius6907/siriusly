...
import { agents } from "@sirius-eco-system/db";
import type { HireApprovedPayload } from "@sirius-eco-system/adapter-utils";
import { findServerAdapter } from "../adapters/registry.js";
import { logger } from "../middleware/logger.js";
import { logActivity } from "./activity-log.js";

const HIRE_APPROVED_MESSAGE =
  "Tell your user that your hire was approved, now they should assign you a task in SiriusEcoSystem or ask you to create issues.";
