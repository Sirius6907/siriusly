/**
 * PluginEventBus — typed in-process event bus for the SiriusEcoSystem plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@sirius-eco-system/shared";
import type { PluginEvent, EventFilter } from "@sirius-eco-system/plugin-sdk";
