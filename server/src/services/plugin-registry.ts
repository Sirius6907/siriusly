 ...
 * the SiriusEcoSystem service layer.
 *
...
export function pluginRegistryService(db: Db) {
  ...
  return {
     ...
     */
    install: async (input: InstallPlugin, manifest: SiriusEcoSystemPluginManifestV1) => {
    ...
    /**
     * Create or update a persistent mapping between a SiriusEcoSystem object and an
     * external entity.
     *
     * @param pluginId - The UUID of the plugin.
