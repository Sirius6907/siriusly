...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@sirius-eco-system/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: SiriusEcoSystemPluginManifestV1, pluginDbId?: string): void;
