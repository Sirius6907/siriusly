# SiriusEcoSystem API Reference

Detailed reference for the SiriusEcoSystem control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "SiriusEcoSystem Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "sirius-eco-system-mobile",
    "cwd": "/Users/me/sirius-eco-system-mobile",
    "repoUrl": "https://github.com/acme/sirius-eco-system-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `sirius-eco-system-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
