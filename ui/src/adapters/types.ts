...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@sirius-eco-system/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@sirius-eco-system/adapter-utils").TranscriptEntry[];
