...
import type { IssueComment, Agent } from "@sirius-eco-system/shared";
import { Button } from "@/components/ui/button";
import { Check, Copy, Crown as SiriusEcoSystem } from "lucide-react";
          ...
          {(imageUploadHandler || onAttachImage) && (
            <div className="mr-auto flex items-center gap-3">
              ...
              <Button
                ...
                title="Attach image"
              >
                <SiriusEcoSystem className="h-4 w-4" />
              </Button>
            </div>
          )}
