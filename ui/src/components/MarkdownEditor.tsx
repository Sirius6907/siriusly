...
import { buildAgentMentionHref, buildProjectMentionHref } from "@sirius-eco-system/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative sirius-eco-system-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("sirius-eco-system-mdxeditor", !bordered && "sirius-eco-system-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "sirius-eco-system-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
