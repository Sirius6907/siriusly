...
export function OnboardingWizard() {
  ...
  const { data: adapterModels } = useQuery({
    queryKey: ["adapter-models", adapterType, createdCompanyId],
    queryFn: () => createdCompanyId ? agentsApi.adapterModels(createdCompanyId, adapterType) : Promise.resolve([]),
    enabled: onboardingOpen && step === 2 && !!createdCompanyId,
  });
