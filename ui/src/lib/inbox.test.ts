...
import type { Approval, DashboardSummary, HeartbeatRun, Issue, JoinRequest } from "@sirius-eco-system/shared";
import {
...
describe("inbox helpers", () => {
  ...
  it("maps legacy new-tab storage to mine", () => {
    localStorage.setItem("siriusEcoSystem:inbox:last-tab", "new");
    expect(loadLastInboxTab()).toBe("mine");
  });
});
