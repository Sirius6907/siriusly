...
export const DISMISSED_KEY = "siriusEcoSystem:inbox:dismissed";
export const READ_ITEMS_KEY = "siriusEcoSystem:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "siriusEcoSystem:inbox:last-tab";
