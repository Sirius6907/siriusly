...
import { AGENT_ROLES } from "@sirius-eco-system/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("sirius-eco-system/siriusEcoSystem/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in SiriusEcoSystem runtime skills are added automatically.
              </p>
            </div>
