 ...
 *
 * This is placed on `globalThis.__siriusEcoSystemPluginBridge__` and consumed by
...
declare global {
  ...
  var __siriusEcoSystemPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__siriusEcoSystemPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__siriusEcoSystemPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
